        ...
        function dateRideTypeWiseEarningStatistics(date) {
            $.get({
                ...
                success: function (response) {
                    ...
                    let scheduledRideEarning = parseFloat(response.totalAdminCommission.scheduled);
                    ...
                    $("#totalEarning").html(abbreviateNumber((parcelEarning+rideEarning+scheduledRideEarning).toFixed(point)))
                    let options;
                    let chart;
                    if(parcelEarning > 0 || rideEarning > 0 || scheduledRideEarning > 0){
                    ...
                    options = {
                        series: [parcelEarning, rideEarning, scheduledRideEarning],
                        chart: {
                            width: 200,
                            type: 'donut',
                        },
