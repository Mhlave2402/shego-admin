...
//hook is look for a autoloaded function to perform action after payment
    ...
    public function payment(Request $request)
    {
        ...
        sendDeviceNotification(
            ...
            description: textVariableDataFormat(value: $push['description'], paidAmount: $trip->paid_fare, methodName: translate(key: $request->payment_method, locale: $trip?->driver?->current_language_key), locale: $trip?->driver?->current_language_key),
            status: $push['status'],
