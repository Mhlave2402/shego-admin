                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('admin.vehicle.export') }}?status={{ request()->get('status') ?? 'all' }}&&search={{ request()->get('search') }}&&file=excel">{{ translate('excel') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            @endcan
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <thead class="table-light align-middle">
                                                <tr>
                                                    ...
                                                    <th class="sl">{{ translate('Vehicle_ID') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($vehicles as $key => $vehicle)
                                                    <tr id="hide-row-{{ $vehicle->id }}" class="record-row">
                                                        ...
                                                        <td class="sl"><a href="{{$vehicle?->driver?->id ? route('admin.driver.show', $vehicle?->driver?->id) : ""}}">{{ $vehicle?->driver?->full_name ?? ($vehicle?->driver?->first_name? $vehicle?->driver?->first_name .' '. $vehicle?->driver?->last_name :"N/A") }}</a></td>
                                                        <td class="sl">
